...
var MetricDescriptorConfig = MetricDescriptor{
	...
	Labels: []string{},
	MetricProps: []MetricProps{
		{Type: prometheus.CounterValue, Name: "listen_backlog", Help: ""},
		{Type: prometheus.CounterValue, Name: "disable_pqexec", Help: ""},
		{Type: prometheus.CounterValue, Name: "pkt_buf", Help: ""},
		{Type: prometheus.GaugeValue, Name: "max_client_conn", Help: ""},
		{Type: prometheus.GaugeValue, Name: "default_pool_size", Help: ""},
		{Type: prometheus.GaugeValue, Name: "min_pool_size", Help: ""},
		{Type: prometheus.GaugeValue, Name: "reserve_pool_size", Help: ""},
		{Type: prometheus.GaugeValue, Name: "reserve_pool_timeout", Help: ""},
		{Type: prometheus.GaugeValue, Name: "max_db_connections", Help: ""},
		{Type: prometheus.GaugeValue, Name: "max_user_connections", Help: ""},
		{Type: prometheus.GaugeValue, Name: "autodb_idle_timeout", Help: ""},
		{Type: prometheus.GaugeValue, Name: "server_reset_query_always", Help: ""},
		{Type: prometheus.GaugeValue, Name: "server_check_delay", Help: ""},
		{Type: prometheus.GaugeValue, Name: "query_timeout", Help: ""},
		{Type: prometheus.GaugeValue, Name: "query_wait_timeout", Help: ""},
		{Type: prometheus.GaugeValue, Name: "client_idle_timeout", Help: ""},
		{Type: prometheus.GaugeValue, Name: "client_login_timeout", Help: ""},
		{Type: prometheus.GaugeValue, Name: "idle_transaction_timeout", Help: ""},
		{Type: prometheus.GaugeValue, Name: "server_lifetime", Help: ""},
		{Type: prometheus.GaugeValue, Name: "server_idle_timeout", Help: ""},
		{Type: prometheus.GaugeValue, Name: "server_connect_timeout", Help: ""},
		{Type: prometheus.GaugeValue, Name: "server_login_retry", Help: ""},
		{Type: prometheus.GaugeValue, Name: "server_round_robin", Help: ""},
		{Type: prometheus.GaugeValue, Name: "suspend_timeout", Help: ""},
		{Type: prometheus.GaugeValue, Name: "dns_max_ttl", Help: ""},
		{Type: prometheus.GaugeValue, Name: "dns_nxdomain_ttl", Help: ""},
		{Type: prometheus.GaugeValue, Name: "dns_zone_check_period", Help: ""},
		{Type: prometheus.GaugeValue, Name: "max_packet_size", Help: ""},
		{Type: prometheus.GaugeValue, Name: "sbuf_loopcnt", Help: ""},
		{Type: prometheus.GaugeValue, Name: "tcp_defer_accept", Help: ""},
		{Type: prometheus.GaugeValue, Name: "tcp_socket_buffer", Help: ""},
		{Type: prometheus.GaugeValue, Name: "tcpkeepalive", Help: ""},
		{Type: prometheus.GaugeValue, Name: "tcp_keepcnt", Help: ""},
		{Type: prometheus.GaugeValue, Name: "tcp_keepidle", Help: ""},
		{Type: prometheus.GaugeValue, Name: "tcp_keepintvl", Help: ""},
		{Type: prometheus.GaugeValue, Name: "verbose", Help: ""},
		{Type: prometheus.GaugeValue, Name: "stats_period", Help: ""},
		{Type: prometheus.GaugeValue, Name: "log_connections", Help: ""},
		{Type: prometheus.GaugeValue, Name: "log_disconnections", Help: ""},
		{Type: prometheus.GaugeValue, Name: "log_pooler_errors", Help: ""},
		{Type: prometheus.GaugeValue, Name: "application_name_add_host", Help: ""},
	},
}
